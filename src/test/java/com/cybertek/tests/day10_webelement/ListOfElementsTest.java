...
public class ListOfElementsTest {
    ...
    verify that none of the sport buttons are selected
     */
    @Test
    public void ListOfRadioButtons() {
        ...
        //if the locator does not much anything returns empty list
    ...
    get all links presented in the page
    print their text
     */
    ...
    public void getAllLinkText(){
      ...
      List<WebElement> links=driver.findElements(By.tagName("a"));
        ...
        //get text of each link and print
    ...
    public void amazonTest() throws InterruptedException {
        ...
        List<WebElement> allResults = driver.findElements(By.cssSelector("span.a-size-base-plus.a-color-base.a-text-normal"));
