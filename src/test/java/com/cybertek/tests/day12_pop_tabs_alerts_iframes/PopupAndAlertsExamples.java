...
public class PopupAndAlertsExamples {
    ...
    @Test
    public void jsAlertsSensKeys() throws InterruptedException {
        driver.get("http://practice.cybertekschool.com/javascript_alerts");
...
//THE EXAMPLE WHEN POPUP is NOT permanent how to handle(from Maruf experience)
    @Test
    public void jsAlertsSensKeys1() throws InterruptedException {
        driver.get("http://practice.cybertekschool.com/javascript_alerts");
